...
var addButton=document.querySelector(".task_button-add");//add button
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="task__button task_button-edit";

    deleteButton.className="task__button task_button-delete";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".task_button-edit");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".task_button-edit");
    var deleteButton=taskListItem.querySelector(".task_button-delete");
